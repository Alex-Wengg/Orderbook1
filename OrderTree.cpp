...
size_t OrderTree::size() const
{
    return this->order_map.size();
}

OrderList& OrderTree::get_price_list(int price)
{
    return price_map.at(price);
}

Order& OrderTree::get_order(int order_id)
{
    return order_map.at(order_id);
}
